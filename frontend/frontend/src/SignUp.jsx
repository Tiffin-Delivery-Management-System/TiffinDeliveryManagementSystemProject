                     ...
                     <form action="/" method="post" onSubmit={handleSubmit}>
                        <div className="groupField">
                           <div className="signupGroup">
                              ...
                              <input onChange={handleChange} type="text" className="form-control" id="name" placeholder="name"
                                 name="name" required />
                           </div>
                           {/* <div className="signupGroup">
                              <label for="lastName" className="form-label">Last Name</label>
                              <input onChange={handleChange} type="text" className="form-control" id="lastName" placeholder="Last Name"
                                 name="lastName" required />
                           </div> */}
                        </div>
                        <div className="signupGroup">
                           <label for="email" className="form-label">Email address</label>
                           <input onChange={handleChange} type="email" className="form-control" id="email" placeholder="Email address"
                              name="email" required />
                        </div>
                        <div className="signupGroup">
                        ...
                        <div className="signupGroup">
                           ...
                           <input onChange={handleChange} type="tel" maxLength={10} className="form-control" id="phoneNo" placeholder="(+91)Phone Number"
                              name="phoneNo" required />
                        </div>
                        <div className="signupGroup">
                           <label for="address" className="form-label">address</label>
                           <input onChange={handleChange} type="text" className="form-control" id="address" placeholder="address"
